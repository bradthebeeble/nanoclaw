...
export function writeSessionMessage(
  ...
  // Fire-and-forget: non-critical bookkeeping, do not block the sync write path
  void updateSession(sessionId, { last_active: new Date().toISOString() });
}
